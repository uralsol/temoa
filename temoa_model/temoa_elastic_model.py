...
def temoa_create_elastic_model ( name='The Temoa Energy System Model' ):
    """\
  ...
  """
    ...
    M.V_DemandSegment = Var(M.DemandConstraint_psdcz,
                            bounds=DemandSegment_bound_rule, initialize=0.0)
    ...
    M.RealObjective = Constraint(rule=real_obj) #STOCH ELASTIC
